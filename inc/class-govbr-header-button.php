...
class IphanBlocksyGovbrHeaderButton {
    ...
    protected function init() {
        add_action('after_setup_theme', array($this, 'iphan_blocksy_register_nav_menus'));
        add_action('blocksy:header:before', array($this, 'iphan_blocksy_govbr_header_button'));
        add_action('blocksy:header:offcanvas:mobile:bottom', array($this, 'iphan_blocksy_govbr_header_mobile_menu'));
        add_action('wp_head', array($this, 'iphan_blocksy_govbr_header_button_styles'));
        add_action('wp_footer', array($this, 'iphan_blocksy_govbr_header_button_script'));
    }
...
IphanBlocksyGovbrHeaderButton::get_instance();
